 ...
 * 
 * $Id: class.tx_commerce_db_product.php 48167 2011-05-26 09:42:39Z ischmittis $
 */
 /**
  * @todo
  * 
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/commerce/lib/class.tx_commerce_db_product.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/commerce/lib/class.tx_commerce_db_product.php']);
}
?>
