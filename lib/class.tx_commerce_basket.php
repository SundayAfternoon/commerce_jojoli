 ...
 *
 * $Id: class.tx_commerce_basket.php 22619 2009-07-22 11:40:03Z ischmittis $
 **/
...
class tx_commerce_basket extends tx_commerce_basic_basket{
	...
	function store_data_to_database()
	{
		...
		foreach ($this->basket_items as $oneuid  => $one_item) {
			if($one_item instanceof tx_commerce_basket_item) {
		...
		if (is_object($this->basket_items[$oneuid]) && $this->basket_items[$oneuid] instanceof tx_commerce_basket_item) {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/commerce/lib/class.tx_commerce_basket.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/commerce/lib/class.tx_commerce_basket.php']);
}
?>
