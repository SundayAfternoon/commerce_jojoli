 ...
 * @subpackage tx_commerce
 * 
 * $Id: class.tx_commerce_article.php 22416 2009-07-16 21:41:28Z lolli $
 */
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/commerce/lib/class.tx_commerce_article.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/commerce/lib/class.tx_commerce_article.php']);
}
?>
